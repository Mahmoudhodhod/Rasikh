...
class _ReportsHubScreenState extends ConsumerState<ReportsHubScreen>
  ...
  void initState() {
    ...
    final initialIndex = ref.read(reportsTabIndexProvider);
    ...
    _tabController.addListener(() {
      if (!_tabController.indexIsChanging) {
        ref.read(reportsTabIndexProvider.notifier).state = _tabController.index;
      }
    });

    ref.listenManual<int>(reportsTabIndexProvider, (previous, next) {
  ...
  Widget build(BuildContext context) {
    ...
    final currentIndex = ref.watch(reportsTabIndexProvider);
        ...
        children: [
          Container(
            ...
            child: TabBar(
              ...
              onTap: (i) =>
                  ref.read(reportsTabIndexProvider.notifier).state = i,
          ...
          Expanded(
            child: TabBarView(
              controller: _tabController,
              children: [ReportsScreen(), CertificatesPage()],
            ),
          ),
        ],
      ),
